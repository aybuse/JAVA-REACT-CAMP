...
public class main {
	...
	public static void main(String[] args)// main:çalýþmaya baþlangýç noktasý
	{
		...
		// deðiþken isimlendirmelerinde camelCase(ilk kelimenin ilk harfi küçük sonraki kelimelerin ilk harfi büyük)kullanýlýr
		...
		// yukarýda yazýlanlarý aþaðýdaki þekilde  dizi haline getirerek kullanýmýný kolaylaþtýrýrýz

		String[] krediler = { "Hýzlý Kredi", "Mutlu Emekli Kredi", "Konut Kredi", "Çiftçi Kredi", "Mbs Kredi" };
		
		
		
		// for döngüsü : belirtilen miktar kadar döngü çalýþýr 2 kullanýmý vardýr
		//1.kullanýmý
		...
		//2.kullanýmý
		for (int i = 0; i < krediler.length; i += 1)//krediler.length dizideki eleman sayýsýný gösterir
			{
			System.out.println(krediler[i]);//deðiþen i deðerine göre o deðere karþýlýk gelen ifadelerin sýrasýyla yazdýrýlmasýný saðlar
		...
		sayilar1 = sayilar2;// sayilar1 in adresi sayilar2 nin adresine eþitlendikten sonra ayný adresi tuttuklarý için aralarýnda baðlantý vardýr 
		sayilar2[0] = 100;
